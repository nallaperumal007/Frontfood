            ...
            <header className='h-100 min-vh-100 d-flex flex-column justify-content-center align-items-center text-light shadow'>
                <div className='container'>
                    ...
                    <div className='d-flex flex-column align-items-center'>
                        ...
                        <div className='mb-3'>
                            <a href='https://food-admin-sigma.vercel.app/login' className='btn btn-danger btn-lg btn-block'>Admin</a>
                        </div>
                        <div className='mb-3'>
                            <a href='https://qrcode-seven-theta.vercel.app' className='btn btn-danger btn-lg btn-block'>QrCode</a>
                        </div>
                    </div>
                </div>
            </header>
